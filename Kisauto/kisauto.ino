...
#define HIGH_SPEED 200 // Magas sebesség
#define MID_SPEED 100  // Közepes sebesség
#define LOW_SPEED 70   // Alacsony sebesség
...
#define speedPinR 6          // PWM kimenet jobb első motorra
#define RightMotorDirPin1 24 // Irányvezérlés IN1
#define RightMotorDirPin2 25 // Irányvezérlés IN2

// Elülső bal motorvezérlés
#define LeftMotorDirPin1 22 // IN3
#define LeftMotorDirPin2 23 // IN4
#define speedPinL 5       // PWM kimenet bal első motorra

// Hátsó jobb motorvezérlés
#define speedPinRB 8
#define RightMotorDirPin1B 28 // IN1 (hátsó jobb)
#define RightMotorDirPin2B 29 // IN2 (hátsó jobb)

// Hátsó bal motorvezérlés
#define LeftMotorDirPin1B 26 // IN3 (hátsó bal)
#define LeftMotorDirPin2B 27 // IN4 (hátsó bal)
#define speedPinLB 7        // PWM kimenet hátsó bal motorra
...
void tracking()
{
    ...
    int s0 = !digitalRead(sensor5); // bal szél
    int s1 = !digitalRead(sensor4); // bal közép
    int s2 = !digitalRead(sensor3); // közép
    int s3 = !digitalRead(sensor2); // jobb közép
    int s4 = !digitalRead(sensor1); // jobb szél
    ...
    else if (senstr == "11100" || senstr == "10100")
    {
        Serial.println("Slight Shift Left");
        forward(0, HIGH_SPEED); // csak jobb oldal megy
    }

    else if (senstr == "01100" || senstr == "11110" || senstr == "10010" || senstr == "10110" || senstr == "11010")
    {
        Serial.println("Slight Left");
        forward(LOW_SPEED, MID_SPEED);
    }

    else if (senstr == "01110" || senstr == "01010" || senstr == "00100" || senstr == "10001" ||
    ...
    else if (senstr == "00110" || senstr == "01111" || senstr == "01001" || senstr == "01011" || senstr == "01101")
    {
        Serial.println("Slight Right");
        forward(MID_SPEED, LOW_SPEED);
    }

    else if (senstr == "00111" || senstr == "00101")
    {
        Serial.println("Slight Shift to Right");
        forward(HIGH_SPEED, 0); // csak bal oldal megy
    }

    else if (senstr == "00001" || senstr == "00010" || senstr == "00011")
    {
